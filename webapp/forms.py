...
class changepasswordform(PasswordChangeForm):
    ...
    def __init__(self, *args, **kwargs):
            ...
            self.fields['old_password'].help_text = '<span class ="form-text text-muted "><small>Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.</small></span>'
            ...
            self.fields['new_password2'].widget.attrs['placeholder'] = 'Comfirm PassWord'
